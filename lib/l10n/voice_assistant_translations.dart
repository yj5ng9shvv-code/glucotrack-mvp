final voiceAssistantTranslations = <String, Map<String, String>>{
  'en': {
    'voiceAskAi': 'Ask AI',
    'voiceTapPrompt': 'Tap and speak naturally',
  ...
  'de': {
    ...
    'voiceTapPrompt': 'Tippen und ganz natürlich sprechen',
    'voiceListening': 'Ich höre zu…',
    'voiceAnyQuestion': 'Stellen Sie eine beliebige Frage',
  ...
  'fr': {
    ...
    'voiceTapPrompt': 'Appuyez et parlez naturellement',
  ...
  'es': {
    ...
    'voiceTapPrompt': 'Pulse y hable con naturalidad',
  ...
  'it': {
    ...
    'voiceTapPrompt': 'Tocca e parla in modo naturale',
    'voiceListening': 'In ascolto…',
    'voiceAnyQuestion': 'Fai qualsiasi domanda',
  ...
  'pl': {
    ...
    'voiceTapPrompt': 'Naciśnij i mów naturalnie',
  ...
  'uk': {
    ...
    'voiceTapPrompt': 'Натисніть і говоріть звичайними словами',
  ...
  'ru': {
    ...
    'voiceTapPrompt': 'Нажмите и говорите обычными словами',
  ...
  'pt': {
    ...
    'voiceTapPrompt': 'Toque e fale naturalmente',
    'voiceListening': 'A ouvir…',
    'voiceAnyQuestion': 'Faça qualquer pergunta',
  ...
  'nl': {
    ...
    'voiceTapPrompt': 'Tik en spreek op een natuurlijke manier',
  ...
  'ro': {
    ...
    'voiceTapPrompt': 'Apăsați și vorbiți natural',
    'voiceListening': 'Ascult…',
    'voiceAnyQuestion': 'Puneți orice întrebare',
  ...
  'cs': {
    ...
    'voiceTapPrompt': 'Klepněte a mluvte přirozeně',
  ...
  'sk': {
    ...
    'voiceTapPrompt': 'Ťuknite a hovorte prirodzene',
    'voiceListening': 'Počúvam…',
    'voiceAnyQuestion': 'Položte ľubovoľnú otázku',
  ...
  'hu': {
    ...
    'voiceTapPrompt': 'Koppintson, és beszéljen természetesen',
    'voiceListening': 'Hallgatom…',
  ...
  'sv': {
    'voiceAskAi': 'Fråga AI',
    'voiceTapPrompt': 'Tryck och tala naturligt',
  ...
  'da': {
    'voiceAskAi': 'Spørg AI',
    'voiceTapPrompt': 'Tryk og tal naturligt',
    'voiceListening': 'Lytter…',
    'voiceAnyQuestion': 'Stil et valgfrit spørgsmål',
  ...
  'fi': {
    ...
    'voiceTapPrompt': 'Napauta ja puhu luonnollisesti',
    'voiceListening': 'Kuuntelen…',
  ...
  'no': {
    'voiceAskAi': 'Spør AI',
    'voiceTapPrompt': 'Trykk og snakk naturlig',
    'voiceListening': 'Lytter…',
    'voiceAnyQuestion': 'Still et valgfritt spørsmål',
  ...
  'el': {
    ...
    'voiceTapPrompt': 'Πατήστε και μιλήστε φυσικά',
    'voiceListening': 'Ακούω…',
    'voiceAnyQuestion': 'Κάντε οποιαδήποτε ερώτηση',
  ...
  'tr': {
    'voiceAskAi': 'AI’a sor',
    'voiceTapPrompt': 'Dokunun ve doğal konuşun',
    'voiceListening': 'Dinliyorum…',
    'voiceAnyQuestion': 'İstediğiniz soruyu sorun',
  ...
  'bg': {
    ...
    'voiceTapPrompt': 'Натиснете и говорете естествено',
    'voiceListening': 'Слушам…',
    'voiceAnyQuestion': 'Задайте произволен въпрос',
  ...
  'hr': {
    ...
    'voiceTapPrompt': 'Dodirnite i govorite prirodno',
  ...
  'sl': {
    ...
    'voiceTapPrompt': 'Tapnite in govorite naravno',
    'voiceListening': 'Poslušam…',
  ...
  'lt': {
    ...
    'voiceTapPrompt': 'Palieskite ir kalbėkite natūraliai',
    'voiceListening': 'Klausau…',
  ...
  'lv': {
    ...
    'voiceTapPrompt': 'Pieskarieties un runājiet dabiski',
    'voiceListening': 'Klausos…',
    'voiceAnyQuestion': 'Uzdodiet jebkuru jautājumu',
  ...
  'et': {
    ...
    'voiceTapPrompt': 'Puudutage ja rääkige loomulikult',
    'voiceListening': 'Kuulan…',
  ...
  'sr': {
    ...
    'voiceTapPrompt': 'Додирните и говорите природно',
    'voiceListening': 'Слушам…',
  ...
  'sq': {
    'voiceAskAi': 'Pyet AI',
    'voiceTapPrompt': 'Prekni dhe fol natyrshëm',
    'voiceListening': 'Po dëgjoj…',
    'voiceAnyQuestion': 'Bëni çdo pyetje',
  ...
  'mk': {
    ...
    'voiceTapPrompt': 'Допрете и зборувајте природно',
    'voiceListening': 'Слушам…',
    'voiceAnyQuestion': 'Поставете какво било прашање',
  ...
  'is': {
    ...
    'voiceTapPrompt': 'Pikkaðu og talaðu eðlilega',
    'voiceListening': 'Hlusta…',
    'voiceAnyQuestion': 'Spyrðu hvaða spurningar sem er',
